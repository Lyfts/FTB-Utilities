    ...
    public void registerLeaderboards(LeaderboardRegistryEvent event) {
        event.register(
                new Leaderboard.FromStat(
                        new ResourceLocation(FTBUtilities.MOD_ID, "deaths"),
                        StatList.deathsStat,
                        false,
                        Leaderboard.FromStat.DEFAULT));
        event.register(
                new Leaderboard.FromStat(
                        new ResourceLocation(FTBUtilities.MOD_ID, "mob_kills"),
                        StatList.mobKillsStat,
                        false,
                        Leaderboard.FromStat.DEFAULT));
        event.register(
                new Leaderboard.FromStat(
                        new ResourceLocation(FTBUtilities.MOD_ID, "time_played"),
                        StatList.minutesPlayedStat,
                        false,
                        Leaderboard.FromStat.TIME));
        event.register(
                new Leaderboard.FromStat(
                        new ResourceLocation(FTBUtilities.MOD_ID, "jumps"),
                        StatList.jumpStat,
                        false,
                        Leaderboard.FromStat.DEFAULT));
