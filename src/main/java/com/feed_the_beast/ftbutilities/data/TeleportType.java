...
public enum TeleportType {
    ...
    HOME(FTBUtilitiesPermissions.HOMES_BACK, FTBUtilitiesPermissions.HOMES_WARMUP,
            FTBUtilitiesPermissions.HOMES_COOLDOWN),
    WARP(FTBUtilitiesPermissions.WARPS_BACK, FTBUtilitiesPermissions.WARPS_WARMUP,
            FTBUtilitiesPermissions.WARPS_COOLDOWN),
    BACK(FTBUtilitiesPermissions.BACK_BACK, FTBUtilitiesPermissions.BACK_WARMUP, FTBUtilitiesPermissions.BACK_COOLDOWN),
    SPAWN(FTBUtilitiesPermissions.SPAWN_BACK, FTBUtilitiesPermissions.SPAWN_WARMUP,
            FTBUtilitiesPermissions.SPAWN_COOLDOWN),
