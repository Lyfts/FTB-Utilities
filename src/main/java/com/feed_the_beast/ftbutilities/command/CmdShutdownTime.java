...
public class CmdShutdownTime extends CmdBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		if (FTBUtilitiesUniverseData.shutdownTime > 0L) {
			sender.addChatMessage(FTBUtilities.lang(sender, "ftbutilities.lang.timer.shutdown",
					StringUtils.getTimeString(FTBUtilitiesUniverseData.shutdownTime - System.currentTimeMillis())));
		} else {
