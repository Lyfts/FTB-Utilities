...
public class CommandPing extends CmdBase {
	...
	public void processCommand(ICommandSender sender, String[] strings)
		...
		if (mc.getIntegratedServer() != null) {
			sender.addChatMessage(FTBUtilities.lang(sender, "commands.ping.integrated_server"));
			return;
		}
				...
				try {
					...
					networkManager.setNetHandler(new INetHandlerStatusClient() {
						...
						public void handlePong(S01PacketPong sPacketPong) {
							...
							sender.addChatMessage(FTBUtilities.lang(
									sender, "commands.ping.ping",
									StringUtils.getTimeString(latency)));
						}

						@Override
						public void onDisconnect(IChatComponent component) {
							if (latency == -1L) {
								sender.addChatMessage(FTBUtilities.lang(sender, "commands.ping.unknown"));
							}
						}
