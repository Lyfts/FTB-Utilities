...
public class CmdTPAccept extends CmdBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		IChatComponent selfName = StringUtils.color(new ChatComponentText(self.player.getPlayer().getDisplayName()),
				EnumChatFormatting.BLUE);
		IChatComponent otherName = StringUtils.color(new ChatComponentText(other.player.getPlayer().getDisplayName()),
				EnumChatFormatting.BLUE);
		...
		if (selfPlayer.dimension != other.player.getPlayer().dimension
			...
			other.player.getPlayer()
					.addChatMessage(StringUtils.color(
		...
		component.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
				FTBUtilities.lang(other.player.getPlayer(), "ftbutilities.lang.tpa.from_to", otherName, selfName)));
		other.player.getPlayer().addChatMessage(component);

		FTBUtilitiesPlayerData.Timer.TPA.teleport(other.player.getPlayer(), playerMP -> TeleporterDimPos.of(selfPlayer),
				null);
	}
}