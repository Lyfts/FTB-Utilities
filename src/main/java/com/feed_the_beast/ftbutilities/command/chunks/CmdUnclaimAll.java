...
public class CmdUnclaimAll extends CmdBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		if (p.hasTeam()) {
			...
			Notification.of(FTBUtilitiesNotifications.UNCLAIMED_ALL,
					FTBUtilities.lang(sender, "ftbutilities.lang.chunks.unclaimed_all")).send(getCommandSenderAsPlayer(sender).mcServer, sender);
		} else {
