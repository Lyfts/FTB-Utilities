...
public class CmdClaimAs extends CmdBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		ForgePlayer p = new ForgePlayer(Universe.get(),
				UUID.nameUUIDFromBytes("FakePlayerClaimAs".getBytes(StandardCharsets.UTF_8)), "FakePlayerClaimAs");
						...
						case DIMENSION_BLOCKED:
							Notification
									.of(FTBUtilitiesNotifications.CHUNK_CANT_CLAIM,
											FTBUtilities.lang(player,
													"ftbutilities.lang.chunks.claiming_not_enabled_dim"))
